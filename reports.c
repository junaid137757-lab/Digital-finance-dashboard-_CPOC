...
void categoryWiseReport()
{
    ...
    for(i = 0; i < transactionCount; i++)
    {
        ...
        if(found == -1)
        {
            ...
            totals[seenCount] = (strcmp(transactions[i].type, "Expense") == 0)
        ...
        {
            totals[found] += (strcmp(transactions[i].type, "Expense") == 0)
                                  ? transactions[i].amount
                                  : -transactions[i].amount;
        }
    }
    ...
    printf("\n--------------------------------------------------------------------\n");
    printf("CATEGORY-WISE REPORT (Positive = Net Expense, Negative = Net Income)\n");
    printf("--------------------------------------------------------------------\n");
    printf("%-20s%s\n", "CATEGORY", "NET AMOUNT");
    printf("--------------------------------------------------------------------\n");
